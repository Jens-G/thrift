      ...
      final switch (connState_) {
        ...
        case ConnectionState.READ_FRAME_SIZE:
          ...
          if (readWant_ > readBufferSize_) {
            ...
            if (!newBuffer) {
              // The buffer for the requested frame size could not be
              // allocated. Fail just this connection with a regular exception
              // instead of raising an Error, which would unwind out of the
              // libevent callback and stop the whole server.
